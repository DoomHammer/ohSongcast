...
ifeq ($(mac-64),1)
    platform_cflags = -DPLATFORM_MACOSX_GNU -arch x86_64 -mmacosx-version-min=10.7 -stdlib=libc++
    ...
    platform_cflags = -DPLATFORM_MACOSX_GNU -m32 -mmacosx-version-min=10.7 -stdlib=libc++
...
includes = -I$(ohnetdir)/../include/ohnet -I../ohNetGenerated/Build/Include -I$(ohtopologydir)Include/ $(platform_include)
objext = o
libprefix = lib
libext = a
exeext = elf
